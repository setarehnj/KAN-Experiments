...
from training import plot_convergence_curves, ModelLightningModule
...
trainer_chebyshev = pl.Trainer(max_epochs=opt.chebyshev_num_epochs, gpus=[0], log_every_n_steps=opt.steps_til_summary)
trainer_dnn = pl.Trainer(max_epochs=opt.dnn_num_epochs, gpus=[0], log_every_n_steps=opt.steps_til_summary)
trainer_fourier = pl.Trainer(max_epochs=opt.fourier_num_epochs, gpus=[1], log_every_n_steps=opt.steps_til_summary)
trainer_wavelet = pl.Trainer(max_epochs=opt.wavelet_num_epochs, gpus=[1], log_every_n_steps=opt.steps_til_summary)
