...
log_dir = "july_26_logs"
lightening_logs = os.path.join(root_path, log_dir)
#chebyshev_logger = TensorBoardLogger("today_logs", name="chebyshev")
dnn_logger = TensorBoardLogger("today_26_logs", name="dnn")
fourier_logger = TensorBoardLogger("today_26_logs", name="fourier")
...
# Ensure DDP is initialized properly
