...
class CheckpointEnsemble(torch.nn.Module):
    def __init__(self, model_class, checkpoint_paths, model, loss_fn, lr, model_name):
        super().__init__()
        self.models = torch.nn.ModuleList([
            model_class.load_from_checkpoint(path, model, loss_fn, lr, model_name)
...
print(f"learning rate is: {opt.lr}")
